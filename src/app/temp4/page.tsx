...
const ReportView = () => {
  ...
  <img src="/SPP.png" alt="Watermark" className="w-2/3 max-w-xs md:max-w-md lg:max-w-lg object-contain" />
</div>
              ...
              <div className="flex justify-between items-start border-b border-purple-100 pb-6 mb-6 relative z-10">
                <div className="flex items-center">
                  <img src="/SPP.png" alt="Lab Logo" className="h-14 mr-4 print:h-12" />
                  <div>
